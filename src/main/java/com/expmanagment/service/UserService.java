...
import com.expmanagment.exception.*;
import com.expmanagment.repo.SignRepo;
...
public class UserService {
    ...
    public JSONObject add(UserEntity user) {
        ...
        } else if (userRepo.findAllByEmail(user.getEmail()).isPresent()) {
    ...
    public JSONObject register(UserEntity user) {
        // TODO: 检查选项后续有待完善
        Optional<UserEntity> userTemp = userRepo.findById(user.getId());
    ...
    public List<UserEntity> getAllTeachers() {
        List<UserEntity> allTeachers = userRepo.findAllTeachers();
    ...
    public List<UserEntity> getAllStudents() {
        List<UserEntity> allStudents = userRepo.findAllStudents();
    ...
    public List<UserEntity> getAllAdministrators() {
        List<UserEntity> allAdministrators = userRepo.findAllAdministrators();
    ...
    public JSONObject updateUserInfo(UserEntity user) {
        ...
        if (userOptional.isEmpty()) {
            ...
            if (user.getEmail().equals("")) {
                ...
                Optional<UserEntity> allByEmail = userRepo.findAllByEmail(user.getEmail());
    ...
    public JSONObject administratorUpdateUserInfo(UserEntity user) {
        ...
        if (userOptional.isEmpty()) {
            ...
            if (user.getIsActivated() != null) {
                userOptional.get().setIsActivated(user.getIsActivated());
                log.info("管理员修改用户 " + user.getId() + " 激活状态为 " + user.getIsActivated());
            } else {
    ...
    {
        Optional<SignEntity> signEntity = signRepo.findById(userId);
    ...
    public JSONObject verifyPasswordAndSendVerificationEmail(Integer userId) {
        ...
        if (userOptional.isEmpty()) {
            ...
            verificationCodeRepo.save(record);
    ...
    public JSONObject checkVerificationCode(Integer userId, String code) {
        Optional<VerificationCodeEntity> recordOptional = verificationCodeRepo.findById(userId);
